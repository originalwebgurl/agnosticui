...
`)])])],-1),Y=s("p",null,[n("React: "),s("a",{href:"https://github.com/AgnosticUI/agnosticui/blob/master/agnostic-react/src/Disclose.tsx",target:"_blank",rel:"noopener noreferrer"},"component source"),n(", "),s("a",{href:"https://github.com/AgnosticUI/agnosticui/blob/master/agnostic-react/src/stories/Disclose.stories.tsx",target:"_blank",rel:"noopener noreferrer"},"storybook tests")],-1),z=s("div",{class:"mbe32"},null,-1),L=s("div",{class:"flex"},[s("h3",{id:"vue-3",tabindex:"-1"},[s("img",{src:b,alt:"Vue 3 logo"}),n("Vue 3 ")])],-1),Q=s("div",{class:"language-vue"},[s("pre",null,[s("code",null,[s("span",{class:"token tag"},[s("span",{class:"token tag"},[s("span",{class:"token punctuation"},"<"),n("script")]),s("span",{class:"token punctuation"},">")]),s("span",{class:"token script"},[s("span",{class:"token language-javascript"},[n(`
...
`),s("span",{class:"token tag"},[s("span",{class:"token tag"},[s("span",{class:"token punctuation"},"<"),n("template")]),s("span",{class:"token punctuation"},">")]),n(`
  ...
  `),s("span",{class:"token tag"},[s("span",{class:"token tag"},[s("span",{class:"token punctuation"},"</"),n("section")]),s("span",{class:"token punctuation"},">")]),n(`
`),s("span",{class:"token tag"},[s("span",{class:"token tag"},[s("span",{class:"token punctuation"},"</"),n("template")]),s("span",{class:"token punctuation"},">")]),n(`
`)])])],-1),X=s("p",null,[n("Vue 3: "),s("a",{href:"https://github.com/AgnosticUI/agnosticui/blob/master/agnostic-vue/src/components/Disclose.vue",target:"_blank",rel:"noopener noreferrer"},"component source"),n(", "),s("a",{href:"https://github.com/AgnosticUI/agnosticui/blob/master/agnostic-vue/src/stories/Disclose.stories.js",target:"_blank",rel:"noopener noreferrer"},"storybook tests")],-1),Z=s("div",{class:"mbe24"},null,-1),ss=n("Note: Vue 2 is not supported"),ns=s("div",{class:"mbe32"},null,-1),as=s("div",{class:"flex"},[s("h3",{id:"angular",tabindex:"-1"},[s("img",{src:y,alt:"Angular logo"}),n("Angular ")])],-1),ts=s("p",null,[n("In your Angular configuration (likely "),s("code",null,"angular.json"),n(") ensure you're including the common AgnosticUI styles:")],-1),es=s("div",{class:"mbe16"},null,-1),os=s("p",null,[s("code",null,' "styles": ["agnostic/dist/common.min.css"],')],-1),cs=s("div",{class:"mbe24"},null,-1),ls=s("p",null,[n("Add AgnosticUI's "),s("code",null,"AgModule"),n(" module:")],-1),is=s("div",{class:"language-js"},[s("div",{class:"highlight-lines"},[s("br"),s("br"),s("div",{class:"highlighted"},"\xA0"),s("br"),s("br"),s("br"),s("br"),s("br"),s("div",{class:"highlighted"},"\xA0"),s("br"),s("br"),s("br"),s("br"),s("br")]),s("pre",null,[s("code",null,[s("span",{class:"token keyword"},"import"),n(),s("span",{class:"token punctuation"},"{"),n(" NgModule "),s("span",{class:"token punctuation"},"}"),n(),s("span",{class:"token keyword"},"from"),n(),s("span",{class:"token string"},"'@angular/core'"),s("span",{class:"token punctuation"},";"),n(`
...
`)])])],-1),_s=s("p",null,[n("See "),s("a",{href:"https://github.com/AgnosticUI/agnosticui/blob/master/CONTRIBUTING.md#running-monorepo",target:"_blank",rel:"noopener noreferrer"},"Running monorepo"),n(".")],-1);function bs(p,r,u,k,d,g){const a=o("DiscloseExamples"),m=o("Alert");return l(),i("div",null,[F,C,H,I,U,t(a),J,K,V,P,Y,z,L,Q,X,Z,t(m,{type:"warning"},{default:e(()=>[ss]),_:1}),ns,as,ts,es,os,cs,ls,is,ps,rs,us,ks,ds,gs,ms,hs,fs,ws,_s])}var Ds=c(j,[["render",bs]]);export{Ss as __pageData,Ds as default};
