import{_ as n,c as s,o as a,d as t}from"./app.ca4f23be.js";const f='{"title":"Utility Classes &amp; CSS Custom Properties","description":"","frontmatter":{},"headers":[{"level":2,"title":"Layout","slug":"layout"},{"level":3,"title":"Flexbox","slug":"flexbox"},{"level":3,"title":"Margins and Padding","slug":"margins-and-padding"}],"relativePath":"docs/utilities.md","lastUpdated":1647131967315}',p={},o=t(`<h1 id="utility-classes-css-custom-properties" tabindex="-1">Utility Classes &amp; CSS Custom Properties <a class="header-anchor" href="#utility-classes-css-custom-properties" aria-hidden="true">#</a></h1><p>AgnosticUI&#39;s <code>common.min.css</code> contains the CSS utilities but you can alternatively import the utilities as an individual module from <a href="https://github.com/AgnosticUI/agnosticui/blob/master/agnostic-css/public/css-dist/common.utilities.min.csss" target="_blank" rel="noopener noreferrer">agnostic-css/public/css-dist/common.utilities.min.css</a>. It should also be mentioned that you can omit these CSS utilities if you follow the <a href="http://www.agnosticui.com/docs/advanced/advanced-usage.html#modular-css-imports" target="_blank" rel="noopener noreferrer">Modular CSS Imports</a> guide.</p><h2 id="layout" tabindex="-1">Layout <a class="header-anchor" href="#layout" aria-hidden="true">#</a></h2><h3 id="flexbox" tabindex="-1">Flexbox <a class="header-anchor" href="#flexbox" aria-hidden="true">#</a></h3><p>For now, we only support Flexbox for layout. You&#39;re encouraged to prefer the platform for things like <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid" target="_blank" rel="noopener noreferrer">CSS Grid</a>.</p><p>The names used are hopefully self-evident enough to be memorable (you will need to understand the basics of <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout/Basic_Concepts_of_Flexbox" target="_blank" rel="noopener noreferrer">Flexbox</a> itself to use these utitilies effectively).</p><div class="language-css"><pre><code><span class="token selector">.flex</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,19),c=[o];function e(u,l,i,k,r,m){return a(),s("div",null,c)}var g=n(p,[["render",e]]);export{f as __pageData,g as default};
