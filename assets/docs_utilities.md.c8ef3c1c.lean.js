import{_ as n,c as s,o as a,t}from"./app.308e4403.js";const f='{"title":"Utility classes","description":"","frontmatter":{},"headers":[{"level":2,"title":"Layout","slug":"layout"},{"level":3,"title":"Flexbox","slug":"flexbox"},{"level":3,"title":"Margins and Padding","slug":"margins-and-padding"},{"level":3,"title":"Sizes","slug":"sizes"}],"relativePath":"docs/utilities.md","lastUpdated":1638802408899}',p={},o=t(`__VP_STATIC_START__<h1 id="utility-classes" tabindex="-1">Utility classes <a class="header-anchor" href="#utility-classes" aria-hidden="true">#</a></h1><h2 id="layout" tabindex="-1">Layout <a class="header-anchor" href="#layout" aria-hidden="true">#</a></h2><h3 id="flexbox" tabindex="-1">Flexbox <a class="header-anchor" href="#flexbox" aria-hidden="true">#</a></h3><p>For now, we only support Flexbox for layout. You&#39;re encouraged to prefer the platform for things like <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid" target="_blank" rel="noopener noreferrer">CSS Grid</a>.</p><p>The names used are hopefully self-evident enough to be memorable (you will need to understand the basics of <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout/Basic_Concepts_of_Flexbox" target="_blank" rel="noopener noreferrer">Flexbox</a> itself to use these utitilies effectively).</p><div class="language-css"><pre><code><span class="token selector">.flex</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h3 id="sizes" tabindex="-1">Sizes <a class="header-anchor" href="#sizes" aria-hidden="true">#</a></h3><p>You&#39;ll notice in the above <em>logical properties</em> that we have utilized <code>--fluid-N</code> for <a href="https://github.com/AgnosticUI/agnosticui/blob/master/agnostic-css/public/css-src/sizes.css" target="_blank" rel="noopener noreferrer">rem-based sizes</a>. AgnosticUI represents <code>-N</code> with pixel-size equivalent (if the root font is defined at <code>16px</code> which is normally the case); so <code>--fluid-16</code> is literally <code>1rem</code>, <code>--fluid-40</code> is literally <code>2.5rem</code> and so on.</p>__VP_STATIC_END__`,20),c=[o];function e(u,l,i,k,r,m){return a(),s("div",null,c)}var g=n(p,[["render",e]]);export{f as __pageData,g as default};
