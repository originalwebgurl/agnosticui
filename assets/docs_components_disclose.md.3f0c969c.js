...
`)])])],-1),Y=n("p",null,[s("React: "),n("a",{href:"https://github.com/AgnosticUI/agnosticui/blob/master/agnostic-react/src/Disclose.tsx",target:"_blank",rel:"noopener noreferrer"},"component source"),s(", "),n("a",{href:"https://github.com/AgnosticUI/agnosticui/blob/master/agnostic-react/src/stories/Disclose.stories.tsx",target:"_blank",rel:"noopener noreferrer"},"storybook tests")],-1),z=n("div",{class:"mbe32"},null,-1),L=n("div",{class:"flex"},[n("h3",{id:"vue-3",tabindex:"-1"},[n("img",{src:y,alt:"Vue 3 logo"}),s("Vue 3 ")])],-1),Q=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("script")]),n("span",{class:"token punctuation"},">")]),n("span",{class:"token script"},[n("span",{class:"token language-javascript"},[s(`
...
`)])])],-1),yn=n("p",null,[s("See "),n("a",{href:"https://github.com/AgnosticUI/agnosticui/blob/master/CONTRIBUTING.md#running-monorepo",target:"_blank",rel:"noopener noreferrer"},"Running monorepo"),s(".")],-1);function bn(p,r,u,k,d,g){const a=o("DiscloseExamples"),m=o("Alert");return l(),i("div",null,[C,F,I,H,U,t(a),J,K,V,P,Y,z,L,Q,X,Z,t(m,{type:"warning"},{default:e(()=>[nn]),_:1}),sn,an,tn,en,on,cn,ln,pn,rn,un,kn,dn,gn,mn,hn,fn,wn,_n,yn])}var xn=c(j,[["render",bn]]);export{Dn as __pageData,xn as default};
